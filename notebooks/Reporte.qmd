...
```{r}
score_bic_dag1 = score(gbn1, data = data, type = "bic")
score_bic_dag1
```

```{r}
score_aic_dag1 = score(gbn1, data = data, type = "aic")
score_aic_dag1
```
