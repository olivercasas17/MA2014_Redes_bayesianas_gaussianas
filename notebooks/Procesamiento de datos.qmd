...
muestras = read_csv2(ensanut_muestras_path)
...
```{r}
demo = demo %>% select(FOLIO_INT, entidad1, municipio1)
head(demo)
```

```{r}
aire = aire %>% select(Entidad_federativa, Municipio, SO_2, CO, NOx, COV,                           PM_010, PM_2_5, NH_3)
head(aire)
```
